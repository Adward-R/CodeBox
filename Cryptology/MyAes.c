...
// Dong Keyang's Code Begins

void aes_polynomial_mul(unsigned char x[4], unsigned char y[4], unsigned char z[4]) {
   z[0] = x[0]*y[3] + y[0]*x[3] + x[1]*y[2] + y[1]*x[2];
   z[1] = x[1]*y[3] + y[1]*x[3] - x[0]*y[0] - x[2]*y[2];
   z[2] = x[2]*y[3] + y[2]*x[3] - x[0]*y[1] - y[0]*x[1];
   z[3] = x[3]*y[3] - x[1]*y[1];
}
